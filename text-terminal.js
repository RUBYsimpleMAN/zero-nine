...
function ansiiArray (stringteger) {
  const stringSplittedToArr = `${stringteger}`.split('')
  // console.log(stringSplittedToArr)
  const stringtegerLength = stringSplittedToArr.length
  // console.log(stringtegerLength)
  const trinityArr = stringSplittedToArr.map( (element) => arrOfDigits[element])
  // console.log(trinityArr)
  const numberHeight = new Array(8).fill('');
  // console.log(numberHeight)
  const trinityRetyrnedArr = []
  for (let i=0; i<numberHeight.length; i++) {
    for (let n=0; n<trinityArr.length; n++) {
      trinityRetyrnedArr.push(trinityArr[n][i]);
      // console.log(trinityRetyrnedArr)
    }
